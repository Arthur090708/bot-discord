...
module.exports = {
    ...
    execute(client, message) {
        ...
        const methods = ['Desabilitado', 'track', 'queue'];
        ...
        embed.setTimestamp();
        embed.setFooter('Musica em primeiro lugar - Developer Arthur❤️', message.author.avatarURL({ dynamic: true }));

        const saveButton = new MessageButton();

        saveButton.setLabel('Salvar essa musica');
